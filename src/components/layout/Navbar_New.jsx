            ...
            <div className="flex justify-between items-center h-16">
              ...
              >
                <Link to="/" className="flex items-center space-x-3 group">
                  <HealthBridgeLogo className="w-10 h-10 text-hb-primary group-hover:scale-110 transition-transform duration-200" />
                  <div className="hidden sm:block">
                    <span className="text-xl font-bold bg-gradient-hb-primary bg-clip-text text-transparent">
                      {t('appName')}
                    </span>
            ...
            <div className="px-4 pt-4 pb-6 space-y-2 bg-gray-50">
              ...
              {user && (
                <>
                  ...
                  <Link
                    to="/profile"
                    className="block px-4 py-3 rounded-xl text-base font-medium text-gray-600 hover:text-hb-primary hover:bg-white transition-all duration-200 flex items-center space-x-3"
                  >
                  ...
                  {!hasPremium && (
                    <Link
                      to="/pricing"
                      className="block px-4 py-3 rounded-xl text-base font-medium text-amber-700 hover:bg-gradient-to-r hover:from-amber-50 hover:to-orange-50 transition-all duration-200 flex items-center space-x-3"
                    >
                  ...
                  <button
                    onClick={handleLogout}
                    className="block w-full text-left px-4 py-3 rounded-xl text-base font-medium text-red-600 hover:bg-red-50 transition-all duration-200 flex items-center space-x-3"
                  >
